...
# SPsimSeq
Semi-parametric simulation method for bulk and single-cell RNA-seq data
...
pkg.depnd <- c("stats",  "MASS", "SingleCellExperiment",  
         "fitdistrplus",  "graphics", "edgeR", "Hmisc",
         "WGCNA", "limma", "mvtnorm")

devtools::install_deps(pkg.depnd)
